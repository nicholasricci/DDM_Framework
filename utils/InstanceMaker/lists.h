...
typedef struct list_element{
    SPACE_TYPE id;                  /**< The id of the element */
 ...
 *
 */
void list_add_by_id(list * l, const uint64_t element_id);
 ...
 *
 */
void list_add_by_id_ordered(const list l, const uint64_t element_id);
 ...
 *
 */
int list_remove_by_id(list * l, const uint64_t element_id);
 ...
 *
 */
list_element * is_in_list(const list l, const uint64_t element_id);
 ...
 *
 */
list_element * is_in_ordered_list(const list l, const uint64_t element_id);
